document.addEventListener('DOMContentLoaded', () => {
    ...
    const myVideos = [
        ...
        { youtubeId: "El7yOj4H7lw", title: "John Wick Mashup", subtitle: "“You don’t hunt him. He hunts you.”", category: "Mashup Cuts", type: "mashup" },
        { youtubeId: "e9fVDeoYKqI", title: "Wheel of the Time", subtitle: "“Fate is not chosen… it is woven.”", category: "Mashup Cuts", type: "mashup" },
        { youtubeId: "3RkFnMO1AkA", title: "Avatar cut", subtitle: "“Not just a planet… a living soul.”", category: "Mashup Cuts", type: "mashup" },
        ...
        const player = new YT.Player(frameId, {
            events: {
                'onReady': (event) => {
                    ...
                    const settingsBtn = container.querySelector('.yt-settings-btn');
                    const qualityMenu = container.querySelector('.yt-quality-menu');
                    ...
                    if (settingsBtn && qualityMenu) {
                        ...
                        document.addEventListener('click', () => { qualityMenu.style.display = 'none'; });
                    }
                },
                'onStateChange': (event) => {
                    const card = container.closest('.showcase-card');
